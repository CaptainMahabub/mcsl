...
<h2>Loan Deposite</h2>
  ...
  <div class = "form-group">
      <label class = "sr-only" for = "name">Traking No</label>
       &nbsp; &nbsp; &nbsp; &nbsp;<input type = "number" name="trakingno" class = "form-control" id = "name" placeholder = "Tracking No">
   </div>  
   ...
   <div class = "form-group">
      ...
      &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;<input type = "number" name="amount" class = "form-control" id = "name" placeholder = "Amount">
   </div>
   ...
   <div class = "form-group">
      ...
      <input type = "number" name="installmentno" class = "form-control" id = "name" placeholder = "Instalment No">
   </div>
