...
require('db_config.php');
 ...
 <table border="2" class="table table-striped table-bordered bootstrap-datatable datatable">
  <thead>
 <tr><th>ID</th><th>Employee Name</th><th> Month</th><th> Year</th><th>Salary </th><th>Salary Pay Date </th><th>Status</th><th>Actions</th></tr>
</thead>
 <tbody>
<?php
 ...
 ?>	
     ...
     <td><?php echo $data['year_name']?></td>
	  <td><?php echo $data['salary_ammount']?></td>
	   <td><?php echo $data['salary_pay_date']?></td>
	    <td class="center">
								...
								<td class="center">
									...
									<a class="btn btn-info" href="edit_salary.php?id=<?php echo $data['salary_id'] ?>">
