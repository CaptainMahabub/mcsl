...
require('db_config.php');
 ...
 <div class="box-content">
                        ...
                        <thead><tr><th width="4%">ID</th><th width="7%">Account No</th><th width="9%">Date</th><th width="9%">Check Number </th><th width="9%">Ammount</th><th width="14%">Actions</th></tr></thead>
 ...
 ?>	
	...
	<td class="center">								
	<a class="btn btn-info" href="edit_withdraw.php?id=<?php echo $data['id'] ?>">
		<i class="halflings-icon white edit"></i></a>
                                    
                                   
	<a class="btn btn-danger" href="delete_withdraw.php?id=<?php echo $data['id'] ?>">
